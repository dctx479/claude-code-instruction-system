...
- `workflows/ralph-manager.md` - 管理器文档
...
- `workflows/intent-matcher.md` - 匹配算法
...
**文件**:
- `workflows/model-router.md` - 路由算法（7KB）
...
- `workflows/plan-scoped-memory.md` - 工作流文档（8KB）
- `agents/context-archivist.md` - 增强版归档器（修改）
...
- `workflows/autopilot-flow.md` - 5 阶段工作流
...
**文件**:
- `workflows/research-parallel.md` - 并行科研工作流
...
#### Phase 1
- **Ralph Loop**: `commands/general/ralph.md`, `workflows/ralph-manager.md`
- **HUD Statusline**: `.claude/statusline/hud.sh`, `memory/hud-config.json`
- **Intent Detector**: `workflows/intent-matcher.md`, `config/keywords.json`
- **主题系统**: `themes/*.toml`, `tools/cc-patcher.sh`

#### Phase 2
- **Model Router**: `workflows/model-router.md`, `workflows/complexity-scorer.md`
- **Plan-Scoped Memory**: `workflows/plan-scoped-memory.md`
- **TUI Config**: `tools/tui-config/README.md`

#### Phase 3
- **Autopilot**: `commands/general/autopilot.md`, `workflows/autopilot-flow.md`
- **Research Parallel**: `workflows/research-parallel.md`
- **Rust 工具**: `tools/hud-render-rust/`, `tools/git-info-rust/`

### Agent 定义
- **Autopilot**: `agents/autopilot-orchestrator.md`
- **Context Archivist**: `agents/context-archivist.md` (增强)
- **其他 Agent**: `agents/INDEX.md`

### 编排系统
- **策略库**: `workflows/orchestration-patterns.md`
