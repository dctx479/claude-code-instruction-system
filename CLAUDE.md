...
> 配置指南: `docs/CONFIG-FILES-GUIDE.md` | 端口管理: `docs/port-management/PORT-MANAGEMENT-GUIDE.md`
...
3. 展示给用户确认（避免记录错误或噪声）
4. 用户确认后写入 `memory/lessons-learned.md`

**何时触发**：autopilot/ralph 结束、解决重大 bug、完成新功能开发
