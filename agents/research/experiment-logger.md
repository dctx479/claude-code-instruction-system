...
**协作场景**：
- **方法学学习**：从 literature-mentor 的精读报告中提取实验方法和技术细节，转化为实验计划
- **TODO List 转化**：将 literature-mentor 报告中的"实施笔记"或"行动清单"转化为结构化实验任务
- **实验设计优化**：基于 literature-mentor 的批判性分析，避免文献中的方法学缺陷

**工作流程**：
```
Phase 1: 文献方法学提取
literature-mentor 精读相关文献
    ↓
提取实验方法、参数设置、技术细节
    ↓
生成"实施笔记"或"行动清单"
...
```bash
# Step 1: 精读方法学文献
"使用 literature-mentor 解读这篇文献，
重点关注实验方法和参数设置，
生成实施笔记"

# Step 2: 转化为实验计划
"读取 literature-mentor 报告中的实施笔记，
创建实验记录 exp-001，
配置参数：学习率 0.001，batch size 16"
...
**核心价值**: 结构化记录，确保实验可复现
**集成**: 与上下文归档系统和 literature-mentor 深度集成
**参考**: 科研最佳实践
